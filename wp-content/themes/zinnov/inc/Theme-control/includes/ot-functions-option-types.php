...
/**
 * Custom Post magazine Select option type.
 *
 * See @ot_display_by_type to see the full list of available arguments.
 *
 * @param     array     An array of arguments.
...
if ( ! function_exists( 'ot_type_custom_post_magazine_select' ) ) {
  
  function ot_type_custom_post_magazine_select( $args = array() ) {
    ...
    /* format setting outer wrapper */
    echo '<div class="format-setting type-custom-post-magazine-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* setup the post types */
        $post_type = isset( $field_post_type ) ? explode( ',', $field_post_type ) : array( 'magazine' );
        
        /* query posts array */

        $my_posts = get_posts( apply_filters( 'ot_type_custom_post_type_select_query', array( 'post_type' => magazine,'posts_per_page' => -1, 'orderby' => 'title', 'order' => 'ASC', 'slug' => 'ceo-speak', 'post_status' => 'any' ), $field_id ) );
